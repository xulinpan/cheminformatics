...
$0.5$~Da binned intensity vector read by a two-layer perceptron. M1D keeps that binned mass axis but
...
$+0.0460$ ($+0.0382$ to $+0.0548$; $76.7\%$ of targets), and it holds in all three
...
The interface accounts for $105\%$ of the encoder effect and attention for $-5\%$.
...
All three pairwise orderings among the encoder, mass-axis and aggregation effects
hold in every seed. The encoder effect exceeds the
